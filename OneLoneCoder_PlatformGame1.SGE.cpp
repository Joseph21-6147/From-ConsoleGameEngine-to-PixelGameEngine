 ...
 * Port to SDL-GameEngine 20221209
 *   - generic port actions, no specifics
 */
...
class OneLoneCoder_Platformer : public flc::SDL_GameEngine
{
public:
...
private:
	...
	// Sprite Resources
	flc::Sprite *spriteTiles = nullptr;
	flc::Sprite *spriteMan = nullptr;
...
protected:
	virtual bool OnUserCreate()
	{
		...
		spriteTiles = new flc::Sprite("JarioSprites/leveljario.png");
		spriteMan = new flc::Sprite("JarioSprites/minijario.png");
	...
	virtual bool OnUserUpdate(float fElapsedTime)
	{
		...
		for (int x = -1; x < nVisibleTilesX + 1; x++)
		{
			for (int y = -1; y < nVisibleTilesY + 1; y++)
			{
				...
				{
				case '.': // Sky
					FillRect(x * nTileWidth - fTileOffsetX, y * nTileHeight - fTileOffsetY, nTileWidth, nTileHeight, flc::CYAN);
					break;
				case '#': // Solid Block
					//FillRect(x * nTileWidth - fTileOffsetX, y * nTileHeight - fTileOffsetY, nTileWidth, nTileHeight, flc::RED);
				...
				case 'o': // Coin
					...
					break;
				default:
					FillRect(x * nTileWidth - fTileOffsetX, y * nTileHeight - fTileOffsetY, nTileWidth, nTileHeight, flc::BLACK);
					break;
				}
			}
		}
		...
		// Draw Player
		//FillRect((fPlayerPosX - fOffsetX) * nTileWidth, (fPlayerPosY - fOffsetY) * nTileWidth, nTileWidth, TileHeight, flc::GREEN);
		SetPixelMode( flc::Pixel::MASK );
