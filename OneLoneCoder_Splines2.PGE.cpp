...
class OneLoneCoder_Splines : public olc::PixelGameEngine
{
public:
...
protected:
	...
	virtual bool OnUserUpdate(float fElapsedTime)
	{
		...
		FillRect(path.points[nSelectedPoint].x - 1, path.points[nSelectedPoint].y - 1, 3, 3, olc::YELLOW);
		...
		DrawWireFrameModel(vecModelCar, p1.x, p1.y, -r + (3.14159f / 2.0f), 5.0f, olc::CYAN);
