 ...
 *   - this is the one translation unit where I have the OLC_PGE_APPLICATION defined
 */
...
class OneLoneCoder_RPG : public olc::PixelGameEngine
{
public:
	OneLoneCoder_RPG()
	{
...
private:
	...
	std::vector<cDynamic*> m_vecDynamics;
