...
class OneLoneCoder_Asteroids : public flc::SDL_GameEngine
{
public:
...
protected:
	...
	virtual bool Draw(int x, int y, flc::Pixel col = flc::WHITE)
	{
		float fx, fy;
		WrapCoordinates(x, y, fx, fy);
		flc::SDL_GameEngine::Draw(fx, fy, col);
		return true;
	}
	...
	virtual bool OnUserUpdate(float fElapsedTime)
	{
		...
		for (auto &a : vecAsteroids)
		{
			...
			// Draw Asteroids
			DrawWireFrameModel(vecModelAsteroid, a.x, a.y, a.angle, (float)a.nSize, flc::YELLOW);
		}
