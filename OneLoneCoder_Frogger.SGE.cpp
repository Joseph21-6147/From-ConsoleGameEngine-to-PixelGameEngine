 ...
 * Port to SGE-GameEngine 20221204
...
class OneLoneCoder_Frogger : public flc::SDL_GameEngine
{
public:
...
private:
	...
	flc::Sprite *spriteBus = nullptr;
	flc::Sprite *spriteLog = nullptr;
	flc::Sprite *spriteWater = nullptr;
	flc::Sprite *spriteFrog = nullptr;
	flc::Sprite *spritePavement = nullptr;
	flc::Sprite *spriteCar1 = nullptr;
	flc::Sprite *spriteCar2 = nullptr;
	flc::Sprite *spriteWall = nullptr;
	flc::Sprite *spriteHome = nullptr;
...
protected:
	...
	virtual bool OnUserCreate()
	{
		...
		spriteBus = new flc::Sprite("FroggerSprites/bus.png");
		spriteLog = new flc::Sprite("FroggerSprites/log.png");
		spriteWater = new flc::Sprite("FroggerSprites/water.png");
		spriteFrog = new flc::Sprite("FroggerSprites/frog.png");
		spritePavement = new flc::Sprite("FroggerSprites/pavement.png");
		spriteWall = new flc::Sprite("FroggerSprites/wall.png");
		spriteHome = new flc::Sprite("FroggerSprites/home.png");
		spriteCar1 = new flc::Sprite("FroggerSprites/car1.png");
		spriteCar2 = new flc::Sprite("FroggerSprites/car2.png");
		return true;
	}
	...
	virtual bool OnUserUpdate(float fElapsedTime)
	{
		...
		// Handle Input
		if (GetKey(flc::Key::UP).bReleased)	fFrogY -= 1.0f;
		if (GetKey(flc::Key::DOWN).bReleased)	fFrogY += 1.0f;
		if (GetKey(flc::Key::LEFT).bReleased)	fFrogX -= 1.0f;
		if (GetKey(flc::Key::RIGHT).bReleased)	fFrogX += 1.0f;
		...
		for (auto lane : vecLanes)
		{
			...
			for (int i = 0; i < nLaneWidth; i++)
			{
				...
				switch (graphic) // Graphics always make code verbose and less clear
				{
					...
					case '.': 	FillRect((x + i)*nCellSize - nCellOffset, y*nCellSize, nCellSize, nCellSize, flc::BLACK);	break; // Road
				}
