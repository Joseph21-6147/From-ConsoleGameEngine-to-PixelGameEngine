...
public:
	...
	bool OnUserUpdate(float fElapsedTime) override
	{
		...
		if (nPlayerHealth <= 0)
		{
			...
			DrawString(10, 12, L"Your Score: " + std::to_wstring((int)fSurvivalTime));
			DrawString(10, 14, L"High Score: " + std::to_wstring((int)fHighScore));
		...
		for (auto &b : listBombs)
		{
			...
			Draw(b.px, b.py + 1, PIXEL_SOLID, FG_GREEN);
			DrawString(b.px, b.py, std::to_wstring((int)b.fuse + 1));
		}
		...
		DrawString(2, ScreenHeight() - 2, L"Survived: " + std::to_wstring((int)fSurvivalTime));
		DrawString(18, ScreenHeight() - 2, L"Bombs: " + std::to_wstring(nBoomsticks));
		DrawString(30, ScreenHeight() - 2, L"Health: " + std::to_wstring(nPlayerHealth));
		DrawString(45, ScreenHeight() - 2, L"High Score: " + std::to_wstring((int)fHighScore));
...
{
	LudumDare42 demo;
	if (demo.ConstructConsole(60, 63, 10, 10))
		demo.Start();
	return 0;
}
